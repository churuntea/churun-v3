      ...
      >
         ...
         <div className="relative inline-block">
            <motion.div 
              ...
              className="w-32 h-32 bg-emerald-900 rounded-[3rem] flex items-center justify-center shadow-2xl shadow-emerald-900/20"
            >
            ...
            <motion.div 
              ...
              className="absolute -inset-4 border-2 border-dashed border-emerald-900/20 rounded-full opacity-50"
            ></motion.div>
         </div>

         <div className="space-y-4">
            <h1 className="text-3xl font-black text-slate-900 tracking-tight">訂單已圓滿完成</h1>
         ...
         {/* Receipt Card */}
         <div className="bg-white rounded-[3rem] p-8 border border-slate-100 shadow-sm text-left space-y-6">
            <div className="flex justify-between items-center pb-6 border-b border-slate-100 border-dashed">
               ...
               <span className="text-[10px] font-black text-slate-800 uppercase">#{orderId?.slice(-6).toUpperCase() || 'TX9921'}</span>
            </div>
            <div className="flex justify-between items-end">
               <p className="text-[8px] font-black uppercase tracking-widest text-slate-400">結算金額</p>
               <h3 className="text-2xl font-black text-emerald-600 tracking-tighter">NT$ {Number(amount || 0).toLocaleString()}</h3>
            </div>
         </div>
