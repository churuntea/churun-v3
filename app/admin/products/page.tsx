...
function AdminProductsContent() {
  ...
  const [formData, setFormData] = useState({
    ...
    ambassador_personal_reward: "0",
    ambassador_direct_reward: "0",
    partner_personal_reward: "0",
    partner_direct_reward: "0",
    category: "極萃系列",
    stock_count: "100",
    sku: "",
    description: ""
  ...
  const handleEditClick = (product: any) => {
    ...
    setFormData({
      ...
      ambassador_personal_reward: product.ambassador_personal_reward?.toString() || "0",
      ambassador_direct_reward: product.ambassador_direct_reward?.toString() || "0",
      partner_personal_reward: product.partner_personal_reward?.toString() || "0",
      partner_direct_reward: product.partner_direct_reward?.toString() || "0",
    ...
    try {
      ...
      const res = await fetch("/api/products", {
        ...
        body: JSON.stringify({
          ...
          ambassador_personal_reward: Number(formData.ambassador_personal_reward),
